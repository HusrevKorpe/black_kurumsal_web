...
/**
 * Yayındaki kampanyalar; ana sayfa ve kampanyalar sayfası. Silinen dükkan/mekanın
  ...
  return db.campaign.findMany({
    where: {
      AND: [
        ...
        // Hedefi olmayan (GLOBAL) kampanya elenmesin: yalnızca hedefi silinmişse düşer.
